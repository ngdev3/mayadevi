...
class Report extends CI_Controller {
	...
	public function convertUserIsKisan(){
		if (isPostBack()) {
			$isFoundAccountDetail = explode('_',$_POST['search_name']);
			$isUserCheck = $_POST['account_holder'];
			echo json_encode($this->Report_mod->convertUserIsKisan($isFoundAccountDetail[1],$isUserCheck));
		}
	}
