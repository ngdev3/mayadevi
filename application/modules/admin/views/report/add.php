...
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                                           ...
                                           <?php 
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputState2">Type*</label>
                                                   <select id="inputState2" class="form-control" name="type_of_account">
                                                       ...
                                                       <option value="account_name">Account (नाम)</option>
                                                   </select>                                         
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    echo form_input(array('type' =>'number' , 'step'=>'0.01', 'min' =>'0', 'name' => 'rate','maxlength'=>'25', 'class' => 'form-control', 'id' => 'rate_val', 'placeholder' => 'Rate.', 'value' => !empty($postvalue) ? $postvalue : $name ));
                                                 ?>
                                            ...
                                            <div class="form-group col-md-6">
                                                    <label for="inputState2">Total Weight. *</label>
                                                    <?php  $name = @$result->total_weight;
                                                    $postvalue = @$_POST['total_weight'];
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                                                    echo form_input(array('type' =>'number' , 'step'=>'0.01', 'min' =>'0', 'name' => 'total_weight','maxlength'=>'25', 'class' => 'form-control', 'id' => 'total_weight', 'placeholder' => 'Total Weight.', 'value' => !empty($postvalue) ? $postvalue : $name ));
                                                 ?>
                                                   <label  class="error"><div class="help-block" style="color:red"> <?php echo form_error('total_weight'); ?></div></label>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputState2">Total (कट्टी). *</label>
                                                    <?php  $name = @$result->total_katti;
                                                    $postvalue = @$_POST['total_katti'];
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                                                    echo form_input(array('type' =>'number' , 'step'=>'0.01', 'min' =>'0', 'name' => 'total_katti','maxlength'=>'25', 'class' => 'form-control', 'id' => 'total_katti', 'placeholder' => 'Total (कट्टी)', 'value' => !empty($postvalue) ? $postvalue : $name ));
                                                 ?>
                                                   <label  class="error"><div class="help-block" style="color:red"> <?php echo form_error('total_katti'); ?></div></label>
                                                </div>  
                                            ...
                                            <div class="form-group col-md-6">
                                                    <label for="inputState2">Final Amount. *</label>
                                                    <?php  $name = @$result->final_amount;
                                                    $postvalue = @$_POST['final_amount'];
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                                                    echo form_input(array('type' =>'number' , 'step'=>'0.01', 'min' =>'0', 'name' => 'final_amount','maxlength'=>'25', 'class' => 'form-control', 'id' => 'final_amount', 'placeholder' => 'Purchaser Amount.', 'value' => !empty($postvalue) ? $postvalue : $name ));
                                                 ?>
                                                   <label  class="error"><div class="help-block" style="color:red"> <?php echo form_error('purchaser_amount'); ?></div></label>
                                                </div>
                                                <div class="form-group col-md-6">
                                                <label for="inputState2">Type of Payment*</label>
                                                   <select id="inputState2" class="form-control" name="payment_type">
                                                       <option value="cash">cash</option>
                                                       <option value="kisan" selected>kisan</option>
                                                   </select>                                         
                                                </div> 
