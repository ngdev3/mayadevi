                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?=get_flashdata();?>
									...
									<a href="<?php echo base_url('admin/taxinvoice/add');?>" id="back-btn" class="btn cur-p btn-primary pull-right">ADD</a>
...
<script>
 ...
 // change per page values here
        ...
        "ajax": {
            url: "<?php echo base_url(); ?>admin/taxinvoice/view_all?<?php echo $QUERY_STRING; ?>", // json datasource
            type: "post",
...
"orderable": false,  // set orderable for selected columns
    ...
    $(document).ready(function() {  
     ...
     $(".custom_filter").on("change",function(){ 
        ...
        if(status == 'none')
        {
           window.location.href= "<?php echo base_url('admin/taxinvoice/listing'); ?>" ;
        }
